...
public class ItemClaws extends ItemSword{
	...
	private static final ToolMaterial claws = 
			EnumHelper.addToolMaterial("claws", 0, ConfigurationHandler.instance.claw_uses, 3, ConfigurationHandler.instance.claw_damage, 52);
